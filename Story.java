/*
 ============================================================
  Story 2.5 – Integrated Problem Solving in Java
  Author: Ankit Saini
   Story: 2.5
 ============================================================
 Problems implemented in this file:
  1. The Weather Station Data Aggregator
     - Counts temperature record-breaking days

  2. The Concert Seat Manager
     - Detects the first duplicate seat booking

  3. The Cosmic Courier Challenge
     - Finds the minimum possible project deadline

  4. The Security Log Analyzer
     - Supports O(1) range queries using prefix sums

  5. The Spy's Cipher
     - Detects extra or mismatched characters in strings

  6. The Digital Library System
     - Manages books using OOP and polymorphic search
