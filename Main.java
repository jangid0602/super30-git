                ...
                do {
                    ...
                    switch(optionNumber){
                        ...
                        case "2" -> {
                            ...
                            int size = userInput.nextInt();
                            userInput.nextLine();
                            System.out.print("Enter title of the books: ");
                        ...
                        case "5" -> {
                            ...
                            System.out.println("Total bonus payout: "+storiesObject.totalBonus(emp));
                            break;
                        }
                        ...
                        case "7" -> {
                            ...
                            userInput.nextLine();
                            System.out.println(storiesObject.firstDuplicateSeat(bookings)+" seat no is prebooked");
                            break;
                        }
                        ...
                        case "8" -> {
                            ...
                            userInput.nextLine();
                            System.out.println("total days which have higher temperature than previous days: "+ storiesObject.countMaxTempDays(temp));
                            break;
                        }
